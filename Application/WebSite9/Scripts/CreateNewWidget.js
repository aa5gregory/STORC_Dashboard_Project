...
function addNewWidget(count, gridster) {
    ...
    var headerLab = document.createElement("label");
    headerLab.id = "HeadLab-" + count;
    headerLab.innerHTML = "Create Widget";
    headerLab.className = "widgetLabelHeader";
    ...
    Label1.innerHTML = "<br/>Select a Project:";
    Label1.className = "widgetLabel";
    ...
    menuPopup.appendChild(headerLab);
...
function widgetElementCreator(type, count, slNumber, labels) {
    ...
    if (type == "canvas") {
        ...
        Label.className = "widgetCanvasLab";

        var canvasDiv = document.createElement("div");
        canvasDiv.id = "canDiv" + count;
        ...
        divNew.appendChild(element);
        divHold.appendChild(divNew);
    }
}
   ...
   resetFollowing("Select1-" + count);
    ...
    switch(value){
        case "Compost":
            ...
            widgetElementCreator("select", count, 2, "<br/>Select type of waste:");
...
function Select3(count) {
    ...
    switch (value) {
        //Compost Selection 
        case "Foodwaste - By Vendor":
            widgetElementCreator("select",count, 4,"<br/>Select the type of graph you would like to create:");
...
function Select4(count) {
    ...
    if ((value4 == "Donut Chart"|| value4 == "Pie Chart") && value2 == "Foodwaste - By Vendor") {
        ...
        widgetElementCreator("select", count, 5, "<br/>Select one of the following dates:");
    ...
    if ((value4 == "Line Chart" || value4 == "Bar Chart") && value2 == "Foodwaste - By Vendor") {
        widgetElementCreator("input", count, "BegInput","<br/>Please select a beginning date:");
...
function InputBegInput(count) {
    ...
    widgetElementCreator("input", count, "EndInput","<br/>Please select a ending date:");
        ...
        if (value2 == "Foodwaste - By Vendor") {
            ...
            if (value4 == "Pie Chart" || value4 == "Donut Chart") {
                ...
                getDBDataDates("Foodwaste - By Vendor", value3, value5, "01/01/0001", function (callbackDate) {
                    widgetElementCreator("canvas", count, "", value3 + " foodwaste collected on " + value5 + "<br/>");
            ...
            if (value4 == "Line Chart" || value4 == "Bar Chart") {
                ...
                getDBDataDates("Foodwaste - by Vendor Line/Bar", value3, begInput.value, endInput.value, function (callbackDate) {
                    widgetElementCreator("canvas", count, "", value3 + " foodwaste collected between " + begInput.value + " and " + endInput.value +"<br/>");
...
function hideFormAfterGraph(count) {
    ...
    var widgetStatusLab = document.getElementById("HeadLab-" + count);
    widgetStatusLab.innerHTML = "Edit Widget";
    widgetStatusLab.hidden = true;
...
function editWidget(count) {
    ...
    $("#div" + count).find("#LabelCanvas-" + count).remove();
    $("#div" + count).find("#canDiv" + count).remove();
